package com.davidcastella.bgrec.scraper.fixtures;

/**
 * Created by davidkaste on 20/11/14.
 */
public class BoardGameFixture {
    public static String getSettlersOfCatan() {
        return "<boardgames termsofuse=\"http://boardgamegeek.com/xmlapi/termsofuse\">\n" +
                ...
                "\t\t\t\t\t\t\t<name primary=\"true\" sortindex=\"5\">The Settlers of Catan</name>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgamehonor objectid=\"12999\">1996 Origins Awards Best Fantasy or Science Fiction Board Game Winner</boardgamehonor>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgamehonor objectid=\"19625\">2002 Japan Boardgame Prize Best Japanese Game Nominee</boardgamehonor>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgamehonor objectid=\"10365\">2005 Gra Roku Game of the Year</boardgamehonor>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgamehonor objectid=\"22601\">2011 Ludo Award Best Board Game Editor&#039;s Choice Winner</boardgamehonor>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgamehonor objectid=\"21707\">2012 JoTa Best Game Released in Brazil Critic Award</boardgamehonor>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgamepodcastepisode objectid=\"86305\">BGTG - May 2, 2005 (SR: Settlers, Dancing Dice, Basari, Ra, San Marco, Xe Queo!, Ingenious, Star Wars Ep. 2 Card Game, Kapitan Wackelpudding)</boardgamepodcastepisode>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameversion objectid=\"101625\">Brazilian first edition</boardgameversion>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameversion objectid=\"213544\">Bulgarian edition 2008</boardgameversion>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameexpansion objectid=\"138548\">Catan Geographies: Austria</boardgameexpansion>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameexpansion objectid=\"167573\">Catan World Championship Berlin 2014 Special</boardgameexpansion>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameversion objectid=\"42682\">English second edition with alternate colors and 8p optional rules</boardgameversion>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameversion objectid=\"24859\">English third edition 1997</boardgameversion>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameversion objectid=\"249269\">English third edition 2003 with color rules and card box</boardgameversion>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgamepodcastepisode objectid=\"10935\">Episode 5 - Luck &amp;amp; Chaos</boardgamepodcastepisode>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgamepodcastepisode objectid=\"110473\">Episode 7 -- The Philosophy Hour, or Reasons Not To Be An Idiot.</boardgamepodcastepisode>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgamepodcastepisode objectid=\"116267\">Episode 72 March Craziness Dice Game Style Part 1</boardgamepodcastepisode>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgamepodcastepisode objectid=\"127464\">Episode 83-- Live from GEN CON Part 2-- from the show floor</boardgamepodcastepisode>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgamepublisher objectid=\"5657\">Filosofia Édition</boardgamepublisher>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgamepodcastepisode objectid=\"108719\">Garrett&#039;s Games 388 - Expansions and Alternatives: Qwirkle, Catan, and Carcassonne</boardgamepodcastepisode>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameversion objectid=\"20899\">German 10 Jahre Jubiläums-Edition</boardgameversion>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameversion objectid=\"24565\">German fourth edition 2002</boardgameversion>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameversion objectid=\"177963\">Hebrew edition 2010</boardgameversion>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameexpansion objectid=\"128751\">Heroes &amp; Capitols (fan expansion for Settlers of Catan)</boardgameexpansion>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameexpansion objectid=\"91061\">Hexen, Zauberer &amp; Drachen (Fan expansion to Catan: Cities and Knights)</boardgameexpansion>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgamepodcastepisode objectid=\"28050\">I&#039;ve Been Diced! episode 10: Gateway games</boardgamepodcastepisode>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgamepodcastepisode objectid=\"103961\">I&#039;ve Been Diced! episode 47: Ignoble successes and serious SF games</boardgamepodcastepisode>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameaccessory objectid=\"20890\">Im Zeichen des Sechsecks: Klaus Teuber &amp; Die Siedler von Catan</boardgameaccessory>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameexpansion objectid=\"89606\">Kirche, Glaube &amp; Reformation (Fan expansion to Catan: Cities and Knights)</boardgameexpansion>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameexpansion objectid=\"21101\">De Kolonisten van Catan: De Diamanten</boardgameexpansion>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameexpansion objectid=\"41161\">De Kolonisten van Catan: De drie Handelsteden van Noord-Nederland</boardgameexpansion>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameversion objectid=\"24623\">Lithuanian edition</boardgameversion>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgamepodcastepisode objectid=\"122910\">MN 0005 Our Origin Story and Our 7 Most Played Games</boardgamepodcastepisode>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameaccessory objectid=\"145942\">The Official Settlers of Catan Gaming Board</boardgameaccessory>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgamepublisher objectid=\"22\">Piatnik</boardgamepublisher>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameexpansion objectid=\"90100\">Die Pioniere (fan expansion for The Settlers of Catan)</boardgameexpansion>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameversion objectid=\"24758\">Polish edition 2005</boardgameversion>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameversion objectid=\"120561\">Polish second edition</boardgameversion>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgamefamily objectid=\"11505\">Promotional Board Games</boardgamefamily>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgamepodcastepisode objectid=\"113301\">RJ30: Shopping victorious</boardgamepodcastepisode>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgamepodcastepisode objectid=\"115954\">RJ32: La community manager, els LCG, les marietes i un tal Ignacy</boardgamepodcastepisode>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameversion objectid=\"38174\">Romanian edition 2006</boardgameversion>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameversion objectid=\"75933\">Romanian second edition 2010</boardgameversion>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameexpansion objectid=\"22598\">Saggsen-Gadan: De säggs&#039;schn Siedler / Catan-OFFENSIVE in Chemnitz</boardgameexpansion>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameimplementation objectid=\"67239\">Settlers of America: Trails to Rails</boardgameimplementation>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameaccessory objectid=\"140404\">Settlers of Catan Replacement Cards</boardgameaccessory>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgamepodcastepisode objectid=\"62105\">Settlers of Catan with Glen Whitman from FRINGE!</boardgamepodcastepisode>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgamecompilation objectid=\"152959\">The Settlers of Catan: 15th Anniversary Wood Edition</boardgamecompilation>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameexpansion objectid=\"2807\">The Settlers of Catan: 5-6 Player Extension</boardgameexpansion>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameimplementation objectid=\"3972\">The Settlers of Catan: Travel Edition</boardgameimplementation>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameexpansion objectid=\"21046\">Die Siedler von Catan: Atlantis – Szenarien &amp; Varianten</boardgameexpansion>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameexpansion objectid=\"86008\">Die Siedler von Catan: Österreich Edition</boardgameexpansion>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameexpansion objectid=\"31933\">Die Siedler von Catan: Renaissance in der Steiermark &amp; Burgbau auf Chaffenberch</boardgameexpansion>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameexpansion objectid=\"37690\">Die Siedler von Catan: Rincewind und der Tourist  /  Die Gilden von Ankh-Morpork</boardgameexpansion>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameexpansion objectid=\"56157\">Die Siedler von Catan: Schätze, Drachen &amp; Entdecker</boardgameexpansion>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameimplementation objectid=\"1897\">Starfarers of Catan</boardgameimplementation>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameversion objectid=\"129861\">Swedish edtion 2011</boardgameversion>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameaccessory objectid=\"139876\">Table of Catan</boardgameaccessory>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameaccessory objectid=\"140406\">Wooden Viking Pieces (Basic and Expansion)</boardgameaccessory>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameaccessory objectid=\"140407\">Wooden Viking Pieces (Basic Only)</boardgameaccessory>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameaccessory objectid=\"140408\">Wooden Viking Pieces (Cities and Knights Only)</boardgameaccessory>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameaccessory objectid=\"140409\">Wooden Viking Pieces (Seafarers Only)</boardgameaccessory>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameexpansion objectid=\"134277\">World Wonders (fan expansion to Catan)</boardgameexpansion>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameaccessory objectid=\"141863\">Yucatan Adventure Board</boardgameaccessory>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameaccessory objectid=\"140260\">Yucatan Wooden Token Set (125 Tokens)</boardgameaccessory>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<boardgameaccessory objectid=\"140259\">Yucatan Wooden Token Set (95 Pack)</boardgameaccessory>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\n" +
                "\t\t\t<poll name=\"suggested_numplayers\" title=\"User Suggested Number of Players\" totalvotes=\"888\">\n" +
                "\t\t\t\n" +
                "\t\t<results numplayers=\"1\">\t\t\n" +
                "\t\t\t\t\t<result value=\"Best\" numvotes=\"1\" />\n" +
                "\t\t\t\t\t<result value=\"Recommended\" numvotes=\"1\" />\n" +
                "\t\t\t\t\t<result value=\"Not Recommended\" numvotes=\"550\" />\n" +
                "\t\t\t\t</results>\t\t\t\t\t\n" +
                "\t\t\t\n" +
                "\t\t<results numplayers=\"2\">\t\t\n" +
                "\t\t\t\t\t<result value=\"Best\" numvotes=\"5\" />\n" +
                "\t\t\t\t\t<result value=\"Recommended\" numvotes=\"87\" />\n" +
                "\t\t\t\t\t<result value=\"Not Recommended\" numvotes=\"515\" />\n" +
                "\t\t\t\t</results>\t\t\t\t\t\n" +
                "\t\t\t\n" +
                "\t\t<results numplayers=\"3\">\t\t\n" +
                "\t\t\t\t\t<result value=\"Best\" numvotes=\"275\" />\n" +
                "\t\t\t\t\t<result value=\"Recommended\" numvotes=\"469\" />\n" +
                "\t\t\t\t\t<result value=\"Not Recommended\" numvotes=\"59\" />\n" +
                "\t\t\t\t</results>\t\t\t\t\t\n" +
                "\t\t\t\n" +
                "\t\t<results numplayers=\"4\">\t\t\n" +
                "\t\t\t\t\t<result value=\"Best\" numvotes=\"630\" />\n" +
                "\t\t\t\t\t<result value=\"Recommended\" numvotes=\"186\" />\n" +
                ...
                "\t\t\t\t\t<result value=\"Not Recommended\" numvotes=\"346\" />\n" +
                "\t\t\t\t</results>\t\t\t\t\t\n" +
                "\t</poll>\n" +
                "\n" +
                "\t\t\t<poll name=\"language_dependence\" title=\"Language Dependence\" totalvotes=\"258\">\n" +
                "\t\t\t\n" +
                "\t\t<results>\t\t\n" +
                "\t\t\t\t\t<result level=\"1\" value=\"No necessary in-game text\" numvotes=\"17\" />\n" +
                "\t\t\t\t\t<result level=\"2\" value=\"Some necessary text - easily memorized or small crib sheet\" numvotes=\"216\" />\n" +
                "\t\t\t\t\t<result level=\"3\" value=\"Moderate in-game text - needs crib sheet or paste ups\" numvotes=\"24\" />\n" +
                ...
                "\t</poll>\n" +
                "\n" +
                "\t\t\t<poll name=\"suggested_playerage\" title=\"User Suggested Player Age\" totalvotes=\"226\">\n" +
                "\t\t\t<results>\t\t\n" +
                "\t\t\t\t\t<result value=\"2\" numvotes=\"0\" />\n" +
                "\t\t\t\t\t<result value=\"3\" numvotes=\"0\" />\n" +
                "\t\t\t\t\t<result value=\"4\" numvotes=\"0\" />\n" +
                "\t\t\t\t\t<result value=\"5\" numvotes=\"2\" />\n" +
                "\t\t\t\t\t<result value=\"6\" numvotes=\"15\" />\n" +
                "\t\t\t\t\t<result value=\"8\" numvotes=\"102\" />\n" +
                "\t\t\t\t\t<result value=\"10\" numvotes=\"83\" />\n" +
